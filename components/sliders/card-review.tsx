...
const CardReview = memo(
  ({
    ...
    return (
      <div className="relative overflow-hidden w-[320px] min-h-[700px] text-sm shadow-lg shadow-black/80 rounded-lg bg-gradient-to-bl from-black/60 via-lime-400 to-black/60 my-5">
